...
void Terrarium::setUpTiles() {
	...
	case Terrarium::mapType::borders://sets borders layout to board tiles
	{
		for (int i = 0; i < sizeOfBoard; i++) {
			pierwszyRzad.emplace_back(wallTexture, i * 50, 0, true);
		}
		board.push_back(pierwszyRzad);

		drugiRzad.emplace_back(wallTexture, 0, 50, true);
		for (int i = 1; i < sizeOfBoard - 1; i++) {
			drugiRzad.emplace_back(grassTexture, i * 50, 50, false);
		}
		drugiRzad.emplace_back(wallTexture, sizeOfBoard * 50 - 50, 50, true);
		board.push_back(drugiRzad);
		trzeciRzad.emplace_back(wallTexture, 0, 100, true);
		for (int i = 1; i < sizeOfBoard - 1; i++) {
			trzeciRzad.emplace_back(grassTexture, i * 50, 100, false);
		}
		trzeciRzad.emplace_back(wallTexture, sizeOfBoard * 50 - 50, 100, true);
		board.push_back(trzeciRzad);
		czwartyRzad.emplace_back(wallTexture, 0, 150, true);
		for (int i = 1; i < sizeOfBoard - 1; i++) {
			czwartyRzad.emplace_back(grassTexture, i * 50, 150, false);
		}
		czwartyRzad.emplace_back(wallTexture, sizeOfBoard * 50 - 50, 150, true);
		board.push_back(czwartyRzad);
		piatyRzad.emplace_back(wallTexture, 0, 200, true);
		for (int i = 1; i < sizeOfBoard - 1; i++) {
			piatyRzad.emplace_back(grassTexture, i * 50, 200, false);
		}
		piatyRzad.emplace_back(wallTexture, sizeOfBoard * 50 - 50, 200, true);
		board.push_back(piatyRzad);
		szostyRzad.emplace_back(wallTexture, 0, 250, true);
		for (int i = 1; i < sizeOfBoard - 1; i++) {
			szostyRzad.emplace_back(grassTexture, i * 50, 250, false);
		}
		szostyRzad.emplace_back(wallTexture, sizeOfBoard * 50 - 50, 250, true);
		board.push_back(szostyRzad);

		siodmyRzad.emplace_back(wallTexture, 0, 300, true);
		for (int i = 1; i < sizeOfBoard - 1; i++) {
			siodmyRzad.emplace_back(grassTexture, i * 50, 300, false);
		}
		siodmyRzad.emplace_back(wallTexture, sizeOfBoard * 50 - 50, 300, true);
		board.push_back(siodmyRzad);

		for (int i = 0; i < sizeOfBoard; i++) {
			osmyRzad.emplace_back(wallTexture, i * 50, 350, true);
		}
	...
	{
		for (int i = 0; i < sizeOfBoard; i++) {
			pierwszyRzad.emplace_back(grassTexture, i * 50, 0, false);
		}
		board.push_back(pierwszyRzad);
		for (int i = 0; i < sizeOfBoard; i++) {
			drugiRzad.emplace_back(grassTexture, i * 50, 50, false);
		...
		for (int i = 0; i < sizeOfBoard; i++) {
			osmyRzad.emplace_back(grassTexture, i * 50, 350, false);
		}
		board.push_back(osmyRzad);
	}
		break;
	...
	{moveDirection = moveType::down;
		pierwszyRzad.emplace_back(grassTexture, 0, 0, false);
		pierwszyRzad.emplace_back(grassTexture, 50, 0, false);
		pierwszyRzad.emplace_back(grassTexture, 100, 0, false);
		pierwszyRzad.emplace_back(grassTexture, 150, 0, false);
		pierwszyRzad.emplace_back(wallTexture, 200, 0, true);
		pierwszyRzad.emplace_back(grassTexture, 250, 0, false);
		pierwszyRzad.emplace_back(grassTexture, 300, 0, false);
		pierwszyRzad.emplace_back(grassTexture, 350, 0, false);
		board.push_back(pierwszyRzad);

		drugiRzad.emplace_back(grassTexture, 0, 50, false);
		drugiRzad.emplace_back(grassTexture, 50, 50, false);
		drugiRzad.emplace_back(grassTexture, 100, 50, false);
		drugiRzad.emplace_back(grassTexture, 150, 50, false);
		drugiRzad.emplace_back(wallTexture, 200, 50, true);
		drugiRzad.emplace_back(grassTexture, 250, 50, false);
		...
		trzeciRzad.emplace_back(grassTexture, 150, 100, false);
		trzeciRzad.emplace_back(wallTexture, 200, 100, true);
		trzeciRzad.emplace_back(grassTexture, 250, 100, false);
		...
		czwartyRzad.emplace_back(grassTexture, 150, 150, false);
		czwartyRzad.emplace_back(wallTexture, 200, 150, true);
		czwartyRzad.emplace_back(grassTexture, 250, 150, false);
		...
		piatyRzad.emplace_back(grassTexture, 150, 200, false);
		piatyRzad.emplace_back(wallTexture, 200, 200, true);
		piatyRzad.emplace_back(wallTexture, 250, 200, true);
		piatyRzad.emplace_back(wallTexture, 300, 200, true);
		piatyRzad.emplace_back(wallTexture, 350, 200, true);
		board.push_back(piatyRzad);
